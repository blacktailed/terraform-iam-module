...
resource "aws_iam_role" "this" {
  ...
  assume_role_policy = var.create_custom_role_trust_policy ? local.custom_role_trust_policy_condition : data.aws_iam_policy_document.assume_role.json
...
#   )
  ...
  lifecycle {
    precondition {
      condition = var.create_role && var.role_name != null
      error_message = "role name is required variable."
    }
  }
}
